...
namespace ProjetoEdux2._0.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        ProjetoSenaiiContext _ctx = new ProjetoSenaiiContext();

        // variável que vai percorrer nossos métodos com as configurações obtidas no appsettings.json
        private IConfiguration _config;

        //  Método construtor para poder passar essas configs
        ...
        {
            return _ctx.Usuario.Include(a => a.IdPerfilNavigation).FirstOrDefault(u => u.Email == login.Email && u.Senha == login.Senha);
        }
